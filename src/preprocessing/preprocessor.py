...
class RetinaPreprocessor:
    """
    Preprocessing pipeline: circular crop + resize + CLAHE.
    أبسط من نسخة Ben Graham، وبيتجنب مشاكل الـ artifacts اللي بتحصل
    مع الـ Gaussian blur القوي عند حواف الدائرة.
    """
    ...
    def apply_clahe(self, image: np.ndarray) -> np.ndarray:
        """
        بتطبق CLAHE على قناة الإضاءة (L) بس في نظام LAB، عشان
        تحسن التباين المحلي من غير ما تشوّه الألوان.
        الصورة هنا لسه BGR.
        """
